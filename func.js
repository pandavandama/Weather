...
function info_about_your_GMT(){
    ...
    function show_weather_by_id(data, id) {
        ...
        // if(String(Math.abs(times)).length >4)
        // times = parseInt(times+'000');
        // else if(String(Math.abs(times)).length >3)
        // times = parseInt(times+'00');
        // else if(String(Math.abs(times)).length >2)
